...
const enum options{ start = 1,back = 4 , instruction = 8, Exit = 9, toggleColor = 7
};
...
void Menu::show_menu() {
	...
	std::cout << "           |                                                         |                    " << std::endl;
	std::cout << "           |                    7 - Colors (ON/OFF):" << (s.enableColor ? "ON " : "OFF") <<"              |"<< std::endl;
	std::cout << "           |                                                         |                    " << std::endl;
...
void Menu::toggleColor()
{
	...
	s.enableColor = !s.enableColor;   // Flip color mode: true -> false, false -> true
